window.onload = function() {
	...
	BT.MainKeyboardRemoteShipController = new function() {
		...
		this.getKeyAssignments = function(ship) {
			return [
				{key: BT.Keys.W, down: requestAction("turnEngineOn"), up: requestAction("turnEngineOff")},
				{key: BT.Keys.A, down: requestAction("turnLeftBearingOn"), up: requestAction("turnLeftBearingOff")},
				{key: BT.Keys.D, down: requestAction("turnRightBearingOn"), up: requestAction("turnRightBearingOff")},
				{key: BT.Keys.Q, down: requestAction("turnCannonOn"), up: requestAction("turnCannonOff")}
			];
		}
	};
};